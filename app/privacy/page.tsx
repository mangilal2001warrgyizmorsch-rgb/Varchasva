    ...
    <div className="bg-[#1a1c17] text-[#f4f2eb] min-h-screen overflow-hidden font-sans">
      ...
      <section className="relative pt-40 pb-20 px-6 lg:px-24 bg-[#fdfaf6] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-[#111810] leading-tight mb-6">Privacy Policy</h1>
      ...
      <section className="bg-white py-20 px-6 lg:px-24">
        <div className="max-w-3xl mx-auto prose-dharohar space-y-10">
...
function PolicySection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      ...
      <div className="text-gray-600 font-light leading-relaxed space-y-3 text-sm [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_strong]:font-medium [&_strong]:text-[#111810]">{children}</div>
    </div>
  );
}
