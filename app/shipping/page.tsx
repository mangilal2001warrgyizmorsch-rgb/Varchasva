    ...
    <div className="bg-[#1a1c17] text-[#f4f2eb] min-h-screen overflow-hidden font-sans">
      ...
      <section className="relative pt-28 sm:pt-32 md:pt-36 pb-10 sm:pb-12 md:pb-14 px-4 sm:px-8 md:px-12 lg:px-24 bg-[#fdfaf6] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-serif text-[#111810] leading-tight mb-3 sm:mb-4">Shipping & Returns</h1>
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl font-light leading-relaxed">Everything you need to know about how we deliver and our hassle-free return policy.</p>
        </div>
      </section>
      ...
      <section className="bg-white py-10 sm:py-14 md:py-16 px-4 sm:px-8 md:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 mb-8 sm:mb-12">
            {[
              { icon: <Truck size={24} strokeWidth={1.5} className="sm:w-6 sm:h-6" />, title: "Pan-India Delivery", desc: "We deliver to all major cities and most pin codes across India via trusted courier partners." },
              { icon: <Clock size={24} strokeWidth={1.5} className="sm:w-6 sm:h-6" />, title: "3–7 Business Days", desc: "Standard delivery takes 3–7 business days. Metro cities typically receive orders in 3–4 days." },
              { icon: <Package size={24} strokeWidth={1.5} className="sm:w-6 sm:h-6" />, title: "Secure Packaging", desc: "Every bottle is bubble-wrapped and packed in corrugated boxes to ensure zero damage in transit." },
            ].map((s, idx) => (
              <div key={s.title} className={`bg-[#fdfaf6] p-5 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 text-center group hover:border-[#1a4a38]/20 transition-all duration-500 ${idx === 2 ? 'sm:col-span-2 lg:col-span-1 max-w-md sm:max-w-none mx-auto w-full' : ''}`}>
                <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 bg-white rounded-2xl flex items-center justify-center text-[#1a4a38] group-hover:bg-[#1a4a38] group-hover:text-white transition-colors duration-500 border border-gray-100">{s.icon}</div>
                <h4 className="text-base sm:text-lg font-serif text-[#111810] mb-1.5">{s.title}</h4>
          ...
          <div className="space-y-8 sm:space-y-12">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#111810] mb-3 sm:mb-4">How We Ship</h3>
              <div className="space-y-2.5 sm:space-y-3 text-gray-600 font-light leading-relaxed text-xs sm:text-base">
            ...
            <div>
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#111810] mb-3 sm:mb-4">Easy Returns</h3>
              <div className="space-y-2.5 sm:space-y-3 text-gray-600 font-light leading-relaxed text-xs sm:text-base">
      ...
      {/* CTA */}
      <section className="bg-[#fdfaf6] py-10 sm:py-14 md:py-16 px-4 sm:px-8 lg:px-24 border-t border-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-[#111810] mb-3 sm:mb-4">Need Help With Shipping?</h2>
          <p className="text-gray-600 font-light leading-relaxed mb-5 sm:mb-8 max-w-lg mx-auto text-xs sm:text-base">Contact our support team for any shipping enquiries, bulk delivery arrangements, or return requests.</p>
