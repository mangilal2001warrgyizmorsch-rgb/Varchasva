    ...
    return (
      <div className="bg-[#1a1c17] text-[#f4f2eb] min-h-screen font-sans">
        ...
        <div className="pt-32 sm:pt-40 pb-24 sm:pb-32 text-center px-4">
          ...
          <p className="text-gray-400 font-light mb-8 text-sm sm:text-base">
            The product you&apos;re looking for doesn&apos;t exist.
          </p>
          <Link href="/products">
            <PrimaryButton className="px-8 sm:px-10 py-3.5 sm:py-4 text-xs tracking-widest">
              Browse All Products
            </PrimaryButton>
          </Link>
        </div>
    ...
    <div className="bg-[#1a1c17] text-[#f4f2eb] min-h-screen overflow-hidden font-sans">
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-400 font-light overflow-x-auto whitespace-nowrap scrollbar-none py-1">
          <Link href="/" className="hover:text-[#1a4a38] transition-colors">
            Home
          </Link>
          <ChevronRight size={13} className="flex-shrink-0" />
          <Link
            href="/products"
            className="hover:text-[#1a4a38] transition-colors"
          >
            Products
          </Link>
          <ChevronRight size={13} className="flex-shrink-0" />
          <span className="text-[#1a4a38] font-medium truncate">
            {product.title}
          </span>
        </div>
      </motion.div>
      ...
      <section className="bg-[#fdfaf6] py-10 sm:py-14 md:py-16 px-4 sm:px-8 md:px-12 lg:px-24 border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-[#111810]">
              Why Choose Varchasva
            </h2>
          </motion.div>
          <motion.div
            ...
            {[
              {
                ...
                title: "Pure & Natural",
                desc: "Absolutely nothing artificial added. Every drop is 100% pure.",
              },
              {
                icon: <Shield size={24} strokeWidth={1.5} />,
                title: "Cold-Pressed",
                desc: "Zero heat extraction below 40°C to retain all nutrients.",
              },
              {
                icon: <Heart size={24} strokeWidth={1.5} />,
                title: "Heart Healthy",
                desc: "Rich in good fats and natural antioxidants for your wellbeing.",
              },
            ].map((item, idx) => (
              <motion.div
                key={item.title}
                variants={staggerItem}
                className={`bg-white p-5 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 text-center group hover:border-[#1a4a38]/20 hover:shadow-2xl hover:shadow-black/5 transition-all duration-500 hover:-translate-y-1 ${
                  idx === 2
                    ? "sm:col-span-2 lg:col-span-1 max-w-md sm:max-w-none mx-auto w-full"
                    : ""
                }`}
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 bg-[#fdfaf6] rounded-2xl flex items-center justify-center text-[#1a4a38] group-hover:bg-[#1a4a38] group-hover:text-white transition-colors duration-500 border border-gray-100">
                  {item.icon}
                </div>
                <h4 className="text-base sm:text-lg font-serif text-[#111810] mb-1.5 group-hover:text-[#1a4a38] transition-colors">
                  {item.title}
                </h4>
      ...
      <section className="bg-white py-10 sm:py-14 md:py-16 px-4 sm:px-8 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-[#111810]">
              More Pure Oils
            </h2>
          </motion.div>
          <motion.div
      ...
      <div className="flex gap-2.5 sm:gap-3 overflow-x-auto pb-1 scrollbar-none justify-center">
        {product.gallery.map((img, i) => (
          <button
            ...
            className={`relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-lg sm:rounded-xl overflow-hidden border-2 transition-all duration-300 flex-shrink-0 cursor-pointer bg-white ${activeIdx === i ? "border-[#1a4a38] shadow-md" : "border-gray-200 hover:border-[#e2a325]/50 opacity-60 hover:opacity-100"}`}
          >
            <Image
              src={img}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-3 sm:mb-4">
        ...
        <span className="text-[#1a4a38] text-[9px] sm:text-[10px] font-bold tracking-[0.2em] sm:tracking-[0.25em] uppercase">
          {product.category}
        </span>
      </div>
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#111810] mb-3 sm:mb-4 leading-tight">
        {product.title}
      </h1>
      ...
      <p className="text-gray-600 font-light leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base lg:text-lg">
        {product.description}
      </p>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div>
            <div className="text-xs sm:text-sm font-medium text-[#111810]">
              Call Us
            </div>
            <div className="text-[11px] sm:text-xs text-gray-400 font-light">
              +91 89499 44620
            </div>
          </div>
        </div>
...
function ProductTabs({ product }: { product: Product }) {
  ...
  return (
    <motion.section
      className="bg-white py-10 sm:py-14 md:py-16 px-4 sm:px-8 md:px-12 lg:px-24"
      initial="hidden"
      whileInView="visible"
      viewport={viewportOnce}
      variants={fadeInUp}
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex gap-1 mb-6 sm:mb-8 border-b border-gray-100 overflow-x-auto scrollbar-none">
          {tabs.map((tab) => (
            <button
              key={tab.id}
            ...
            {activeTab === "description" && (
              ...
              >
                ...
                <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-[#fdfaf6] rounded-2xl border border-gray-100">
                  <h4 className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-[#1a4a38] mb-2 sm:mb-3 flex items-center gap-2">
                    <div className="w-4 h-[1px] bg-[#e2a325]" /> Ingredients
                  </h4>
            ...
            {activeTab === "benefits" && (
              ...
              >
                {product.benefits.map((b, i) => (
                  ...
                  >
                    <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center flex-shrink-0 text-[#1a4a38] shadow-sm border border-gray-100 group-hover:bg-[#1a4a38] group-hover:text-white transition-colors duration-500">
                      <Check size={13} className="sm:w-3.5 sm:h-3.5" />
                    </div>
                    <p className="text-gray-600 font-light text-xs sm:text-sm leading-relaxed pt-0.5">
                      {b}
                    </p>
                  </motion.div>
                ))}
            ...
            {activeTab === "nutrition" && (
              ...
              >
                <div className="p-4 sm:p-6 border-b border-gray-100">
                  <h4 className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-[#1a4a38] flex items-center gap-2">
                    <div className="w-4 h-[1px] bg-[#e2a325]" /> Nutritional
                    Information
                  </h4>
                </div>
                {product.nutrition.map((n, i) => (
                  ...
                  >
                    ...
                    <span className="text-xs sm:text-sm text-[#111810] font-medium">
                      {n.value}
                    </span>
                  </motion.div>
                ))}
