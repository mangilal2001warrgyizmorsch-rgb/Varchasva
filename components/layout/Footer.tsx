    ...
    <>
      ...
      <footer className="bg-[#fdfaf6] pt-24 pb-10 px-6 md:px-20 text-[#111810]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#1a4a38] mb-8 flex items-center gap-2"><div className="w-4 h-[1px] bg-[#e2a325]"></div> Shop</h4>
            <ul className="space-y-4 text-sm text-gray-500 font-light">
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">All Products</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Cold-Pressed Oils</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Essential Oils</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Wellness Bundles</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Gift Sets</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500 font-light">
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Our Story</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">The Process</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Sustainability</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Journal</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500 font-light">
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">FAQ</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Shipping & Returns</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Track Order</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-[#1a4a38] transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-2">
            ...
            <div className="w-10 h-6 bg-white border border-gray-200 rounded flex items-center justify-center text-[8px] font-bold text-gray-400">VISA</div>
            <div className="w-10 h-6 bg-white border border-gray-200 rounded flex items-center justify-center text-[8px] font-bold text-gray-400">MC</div>
            <div className="w-10 h-6 bg-white border border-gray-200 rounded flex items-center justify-center text-[8px] font-bold text-gray-400">AMEX</div>
            <div className="w-10 h-6 bg-white border border-gray-200 rounded flex items-center justify-center text-[8px] font-bold text-gray-400">PAYPAL</div>
          </div>
        </div>
      </footer>
    </>
